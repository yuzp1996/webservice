...
func main(){
	...
	timehandler := &customhandler.TimeHandler{Format: time.RFC822}
	mux.Handle("/time", timehandler)

	timehandler3339 := &customhandler.TimeHandler{Format: time.RFC3339}
	...
	// post way
	mux.HandleFunc("/login",customhandler.Login)
